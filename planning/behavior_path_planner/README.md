...
| ~/output/path/debug/published_time      | `autoware_internal_msgs::msg::PublishedTime`        | Node publishes its Path publishing time with pipeline header file when `use_published_time` parameter true. | `volatile`     |
